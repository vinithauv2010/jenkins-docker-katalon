...
Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - COMPLETED'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - ONGOING'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - SCHEDULED'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - CANCELLED'), 0)
