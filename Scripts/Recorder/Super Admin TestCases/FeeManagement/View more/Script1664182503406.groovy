...
Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - VIEW ALL'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView -  Filter by Classes (6)'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - A - ABC (1)'), 0)
