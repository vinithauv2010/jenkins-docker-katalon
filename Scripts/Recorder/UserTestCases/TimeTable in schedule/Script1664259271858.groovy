...
Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - Production testing (4)'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - Next (8)'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - (54)'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.view.ViewGroup (35)'), 0)

//Mobile.tap(findTestObject(''), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.ImageView (17)'), 0)

Mobile.tap(findTestObject('Object Repository/testcase/android.widget.TextView - A - XYZ'), 0)
